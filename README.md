...
- Created calculated fields (Delivery Days, AOV, Delivery Status)
- Built Pivot Tables for analysis
- Designed dashboard with KPIs, charts, and slicer
- Derived insights and recommendations
## Dashboard Preview
<img width="1228" height="660" alt="Dashboard" src="https://github.com/user-attachments/assets/83a89a3e-5c83-4909-94c0-94ab810169ab" />
## Dashboard Features
...
## Recommendations
- Improve Standard Class delivery efficiency
- Focus on underperforming regions
- Leverage high-demand categories
## Conclusion
This project demonstrates the ability to analyze retail data and build an interactive Excel dashboard.
The insights help identify key trends and opportunities to improve sales and delivery performance.
## 👤 Author
**Sriramya Durga K**
📧 Data Operations Analyst | Aspiring Data Analyst
🔗 LinkedIn: linkedin.com/in/sriramya-durga-k-3972ab403
